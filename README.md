...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/instapago/instapago/run-tests?label=tests)](https://github.com/abr4xas/php-instapago/actions?query=workflow%3ATests+branch%3Amaster)
